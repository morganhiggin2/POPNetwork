...
namespace POPNetwork.Migrations
{
    ...
    [Migration("20220402204646_RemoveWithOneFromInvitationLinksToVariousTypes")]
    partial class RemoveWithOneFromInvitationLinksToVariousTypes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POPNetwork.Models.GivenInvitationLink", b =>
                {
            ...
            modelBuilder.Entity("POPNetwork.Models.ReceivedInvitationLink", b =>
                {
                    b.Property<string>("invitationId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("POPNetwork.Models.GivenInvitationLink", b =>
                {
                    ...
                    b.HasOne("POPNetwork.Models.Invitation", "invitation")
                        .WithOne("givenInviationLink")
                        .HasForeignKey("POPNetwork.Models.GivenInvitationLink", "invitationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("POPNetwork.Models.ReceivedInvitationLink", b =>
                {
                    ...
                    b.HasOne("POPNetwork.Models.Invitation", "invitation")
                        .WithOne("recievedInviationLink")
                        .HasForeignKey("POPNetwork.Models.ReceivedInvitationLink", "invitationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("POPNetwork.Models.Invitation", b =>
                {
                    b.Navigation("givenInviationLink")
                        .IsRequired();

                    b.Navigation("recievedInviationLink")
                        .IsRequired();
                });
