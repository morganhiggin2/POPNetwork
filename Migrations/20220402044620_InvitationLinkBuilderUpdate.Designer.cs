...
namespace POPNetwork.Migrations
{
    ...
    [Migration("20220402044620_InvitationLinkBuilderUpdate")]
    partial class InvitationLinkBuilderUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POPNetwork.Models.Invitation", b =>
                {
                    b.HasOne("POPNetwork.Models.GivenInvitationLink", "givenInviationLink")
                        .WithOne("invitation")
                        .HasForeignKey("POPNetwork.Models.Invitation", "id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("POPNetwork.Models.ReceivedInvitationLink", "recievedInviationLink")
                        .WithOne("invitation")
                        .HasForeignKey("POPNetwork.Models.Invitation", "id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
